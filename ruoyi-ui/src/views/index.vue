  ...
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>Candy AI 虚拟女友管理系统</h2>
        <p>
          基于若依框架开发的AI虚拟女友管理系统，提供角色管理、对话功能、用户管理等核心功能。系统采用前后端分离架构，后端基于Spring Boot 3和若依框架，前端基于Vue 2和Element UI，具有完善的权限管理和用户界面。
        </p>
        <p>
          <b>当前版本:</b> <span>v{{ version }}</span>
        </p>
        <p>
          <el-tag type="success">AI智能管理</el-tag>
        </p>
        <p>
          <el-button
            type="primary"
            ...
            icon="el-icon-cloudy"
            plain
            @click="goTarget('https://github.com/lianghongbin/candy-ai-server')"
            >访问GitHub</el-button
          >
          <el-button
            size="mini"
    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <div class="body">
            <p>
              <i class="el-icon-s-promotion"></i> 项目地址：<el-link
                href="https://github.com/lianghongbin/candy-ai-server"
                target="_blank"
                >https://github.com/lianghongbin/candy-ai-server</el-link
              >
            </p>
            <p>
              <i class="el-icon-document"></i> 技术栈：Spring Boot 3 + Vue 2 + Element UI
            </p>
            <p>
              <i class="el-icon-info"></i> 基于框架：若依(RuoYi) v3.9.0
            </p>
            <p>
              <i class="el-icon-star-on"></i> 开源协议：MIT License
            </p>
          </div>
        </el-card>
      </el-col>
